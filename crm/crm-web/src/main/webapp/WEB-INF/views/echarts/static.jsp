...
<div class="wrapper">
    ...
    <jsp:include page="../include/sider.jsp">
        <jsp:param name="menu" value="charts_static"/>
    </jsp:include>
    <!-- 右侧内容部分 -->
...
<script>
    $(function () {
        ...
        var pie = echarts.init($("#pie")[0],'chalk');
        var line = echarts.init($("#line")[0],'chalk');
        var bar2 = echarts.init($("#bar2")[0],'chalk');
        var lineBar = echarts.init($("#lineBar")[0],'chalk');
          ...
          bar2.setOption({
              ...
              series: [
                  ...
                  },
                  {
                      name: "小米",
                      type: 'bar',
                      data: [1200, 750, 150, 300, 250, 1000]
                  }
              ]
          });
